 ...
 * @author NESAS
 */
public class frmDetailRuangan extends javax.swing.JFrame {

    /**
     * Creates new form frmDetailRuangan
     */
    public frmDetailRuangan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DETAIL RUANGAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDetailRuangan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmDetailRuangan().setVisible(true);
            }
        });
    }
